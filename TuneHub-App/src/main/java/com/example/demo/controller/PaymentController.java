...
public class PaymentController {
	...
	public String createOrder() {
		Order order = null;
		try {
			RazorpayClient razorpay = new RazorpayClient("rzp_test_hzegTcr3M6IwrT", 
					"hkvPiNS7Md28yBwZvlbFw6HE");
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
	        ...
	        RazorpayClient razorpayClient = new RazorpayClient("rzp_test_hzegTcr3M6IwrT", 
	        								"hkvPiNS7Md28yBwZvlbFw6HE");
